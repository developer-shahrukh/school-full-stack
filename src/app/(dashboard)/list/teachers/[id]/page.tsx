...
import { Teacher } from "@prisma/client/edge";
          ...
          <div className="bg-smSky py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <div className="flex items-center gap-4">
                <h1 className="text-xl text-semibold">{teacher.name +" "+teacher.surname}</h1>
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link
              className="pg-3 rounded-md bg-smSkyLight"
              href={`/list/students?teacherId=${"teacher2"}`}
            >
              Teacher&apos;s Students
            </Link>
            <Link
              className="pg-3 rounded-md bg-smPurpleLight"
              href={`/list/classes?supervisorId=${"teacher2"}`}
            >
              Teacher&apos;s Classes
            </Link>
            <Link
              className="pg-3 rounded-md bg-smYellowLight"
              href={`/list/lessons?teacherId=${"teacher2"}`}
            >
              Teacher&apos;s Lessons
            </Link>
            <Link
              className="pg-3 rounded-md bg-pink-50"
